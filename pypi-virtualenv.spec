...
Source0  : https://files.pythonhosted.org/packages/a9/96/0834f30fa08dca3738614e6a9d42752b6420ee94e58971d702118f7cfd30/virtualenv-20.32.0.tar.gz
...
%prep
%setup -q -n virtualenv-20.32.0
cd %{_builddir}/virtualenv-20.32.0
pushd ..
cp -a virtualenv-20.32.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1753107439
