...
Source0  : https://files.pythonhosted.org/packages/ac/c0/a0a0fb1433e4c3d8d9e2d6c990812e328913c64adcfbcfcae1974af0521c/virtualenv-20.17.0.tar.gz
...
%prep
%setup -q -n virtualenv-20.17.0
cd %{_builddir}/virtualenv-20.17.0
pushd ..
cp -a virtualenv-20.17.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1669825680
