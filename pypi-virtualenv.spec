...
Source0  : https://files.pythonhosted.org/packages/87/14/ca9890d58cd33d9122eb87ffec2f3c6be0714785f992a0fd3b56a3b6c993/virtualenv-20.21.0.tar.gz
...
%prep
%setup -q -n virtualenv-20.21.0
cd %{_builddir}/virtualenv-20.21.0
pushd ..
cp -a virtualenv-20.21.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1678721961
