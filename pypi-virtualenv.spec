...
%prep
%setup -q -n virtualenv-20.13.1
cd %{_builddir}/virtualenv-20.13.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1644182561
...
cp %{_builddir}/virtualenv-20.13.1/LICENSE %{buildroot}/usr/share/package-licenses/pypi-virtualenv/bcaf1877d014a17d06f0e23264c6429acf921d01
