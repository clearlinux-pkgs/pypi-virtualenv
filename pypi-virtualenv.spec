...
Source0  : https://files.pythonhosted.org/packages/38/e0/633e369b91bbc664df47dcb5454b6c7cf441e8f5b9d0c250ce9f0546401e/virtualenv-20.30.0.tar.gz
...
%prep
%setup -q -n virtualenv-20.30.0
cd %{_builddir}/virtualenv-20.30.0
pushd ..
cp -a virtualenv-20.30.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1743455014
