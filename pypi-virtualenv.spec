...
Source0  : https://files.pythonhosted.org/packages/7b/19/65f13cff26c8cc11fdfcb0499cd8f13388dd7b35a79a376755f152b42d86/virtualenv-20.17.1.tar.gz
...
%prep
%setup -q -n virtualenv-20.17.1
cd %{_builddir}/virtualenv-20.17.1
pushd ..
cp -a virtualenv-20.17.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1670499870
