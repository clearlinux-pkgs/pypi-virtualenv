...
Source0  : https://files.pythonhosted.org/packages/26/c6/169a384bfe44de610f5bbc03b3d4cc23a5a64a75be11864a033f2fe195db/virtualenv-20.24.0.tar.gz
...
%prep
%setup -q -n virtualenv-20.24.0
cd %{_builddir}/virtualenv-20.24.0
pushd ..
cp -a virtualenv-20.24.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1689614756
