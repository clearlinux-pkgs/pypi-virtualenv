...
Source0  : https://files.pythonhosted.org/packages/2b/dc/be4da7a7fea4e8c3612a4f1901efc694b4f5f1c30179518ffef88c5f8dde/virtualenv-20.16.7.tar.gz
...
%prep
%setup -q -n virtualenv-20.16.7
cd %{_builddir}/virtualenv-20.16.7
pushd ..
cp -a virtualenv-20.16.7 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1668451351
