...
Source0  : https://files.pythonhosted.org/packages/b4/27/b71df0a723d879baa0af1ad897b2498ad78f284ae668b4420092e44c05fa/virtualenv-20.16.6.tar.gz
...
%prep
%setup -q -n virtualenv-20.16.6
cd %{_builddir}/virtualenv-20.16.6
pushd ..
cp -a virtualenv-20.16.6 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1666744017
