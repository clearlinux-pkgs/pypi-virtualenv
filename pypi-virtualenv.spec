...
Source0  : https://files.pythonhosted.org/packages/9d/17/5a822952d90f791947f9d1d11c84c055ffc3b7a315c2552d4f46a0d6cd12/virtualenv-20.16.2.tar.gz
...
%prep
%setup -q -n virtualenv-20.16.2
cd %{_builddir}/virtualenv-20.16.2
pushd ..
cp -a virtualenv-20.16.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1658966438
