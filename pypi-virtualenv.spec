...
Source0  : https://files.pythonhosted.org/packages/3d/ad/906d59bbcb0e6178989cee52166a8a6651ddaea18b38e728eaac22e61cad/virtualenv-20.19.0.tar.gz
...
%prep
%setup -q -n virtualenv-20.19.0
cd %{_builddir}/virtualenv-20.19.0
pushd ..
cp -a virtualenv-20.19.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1675885960
