...
Source0  : https://files.pythonhosted.org/packages/bf/4c/66ce54c8736ff164e85117ca36b02a1e14c042a6963f85eeda82664fda4e/virtualenv-20.26.5.tar.gz
...
%prep
%setup -q -n virtualenv-20.26.5
cd %{_builddir}/virtualenv-20.26.5
pushd ..
cp -a virtualenv-20.26.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726671511
