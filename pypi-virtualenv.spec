...
Source0  : https://files.pythonhosted.org/packages/4a/71/5d3cefcf514e2edb468669558092caa8673c352fd798e47cf8a4bb3a1566/virtualenv-20.13.4.tar.gz
...
%prep
%setup -q -n virtualenv-20.13.4
cd %{_builddir}/virtualenv-20.13.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1647644994
...
cp %{_builddir}/virtualenv-20.13.4/LICENSE %{buildroot}/usr/share/package-licenses/pypi-virtualenv/bcaf1877d014a17d06f0e23264c6429acf921d01
