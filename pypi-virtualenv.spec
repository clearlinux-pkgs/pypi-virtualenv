...
Source0  : https://files.pythonhosted.org/packages/b8/5c/c6acf0fb35c2e830114a81ae771599e0dd11b5905f2386782fa2793ec6c8/virtualenv-20.15.0.tar.gz
...
%prep
%setup -q -n virtualenv-20.15.0
cd %{_builddir}/virtualenv-20.15.0
pushd ..
cp -a virtualenv-20.15.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1656344590
...
cp %{_builddir}/virtualenv-20.15.0/LICENSE %{buildroot}/usr/share/package-licenses/pypi-virtualenv/bcaf1877d014a17d06f0e23264c6429acf921d01
