...
Source0  : https://files.pythonhosted.org/packages/e2/a1/f6a76cc83255016ded5aa33a5db637c7d31ed51ee8e367139b9c7eae669e/virtualenv-20.13.3.tar.gz
...
%prep
%setup -q -n virtualenv-20.13.3
cd %{_builddir}/virtualenv-20.13.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1646680661
...
cp %{_builddir}/virtualenv-20.13.3/LICENSE %{buildroot}/usr/share/package-licenses/pypi-virtualenv/bcaf1877d014a17d06f0e23264c6429acf921d01
