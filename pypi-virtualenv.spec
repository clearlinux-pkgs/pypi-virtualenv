...
Source0  : https://files.pythonhosted.org/packages/e7/32/925d0ee72929865228d5160ec86c7967aea3f7f257f6f2226fcf08cc2352/virtualenv-20.20.0.tar.gz
...
%prep
%setup -q -n virtualenv-20.20.0
cd %{_builddir}/virtualenv-20.20.0
pushd ..
cp -a virtualenv-20.20.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677626678
