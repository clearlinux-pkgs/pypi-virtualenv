...
Source0  : https://files.pythonhosted.org/packages/07/a3/bd699eccc596c3612c67b06772c3557fda69815972eef4b22943d7535c68/virtualenv-20.16.5.tar.gz
...
%prep
%setup -q -n virtualenv-20.16.5
cd %{_builddir}/virtualenv-20.16.5
pushd ..
cp -a virtualenv-20.16.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1662652546
