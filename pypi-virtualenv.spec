...
Source0  : https://files.pythonhosted.org/packages/93/4f/a7737e177ab67c454d7e60d48a5927f16cd05623e9dd888f78183545d250/virtualenv-20.25.1.tar.gz
...
%prep
%setup -q -n virtualenv-20.25.1
cd %{_builddir}/virtualenv-20.25.1
pushd ..
cp -a virtualenv-20.25.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1708617884
