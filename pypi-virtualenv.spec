...
Source0  : https://files.pythonhosted.org/packages/62/2d/06980235e155c7ee1971f77439cbbc3069e98de49540e89f2291905eb4a8/virtualenv-20.16.4.tar.gz
...
%prep
%setup -q -n virtualenv-20.16.4
cd %{_builddir}/virtualenv-20.16.4
pushd ..
cp -a virtualenv-20.16.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661906422
