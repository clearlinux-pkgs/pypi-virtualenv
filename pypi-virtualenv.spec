...
Source0  : https://files.pythonhosted.org/packages/c7/9c/57d19fa093bcf5ac61a48087dd44d00655f85421d1aa9722f8befbf3f40a/virtualenv-20.29.3.tar.gz
...
%prep
%setup -q -n virtualenv-20.29.3
cd %{_builddir}/virtualenv-20.29.3
pushd ..
cp -a virtualenv-20.29.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742463797
