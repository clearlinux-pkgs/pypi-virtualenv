...
Source0  : https://files.pythonhosted.org/packages/84/8a/134f65c3d6066153b84fc176c58877acd8165ed0b79a149ff50502597284/virtualenv-20.26.4.tar.gz
...
%prep
%setup -q -n virtualenv-20.26.4
cd %{_builddir}/virtualenv-20.26.4
pushd ..
cp -a virtualenv-20.26.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1725749252
