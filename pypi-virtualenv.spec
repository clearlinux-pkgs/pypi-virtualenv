...
Source0  : https://files.pythonhosted.org/packages/6d/0e/0c41bda51d1bd283c69484c932646fcad0b5a36ff5ac9535e4be93aeb89c/virtualenv-20.16.1.tar.gz
...
%prep
%setup -q -n virtualenv-20.16.1
cd %{_builddir}/virtualenv-20.16.1
pushd ..
cp -a virtualenv-20.16.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1658943081
