...
Source0  : https://files.pythonhosted.org/packages/ef/b1/7763026877df6533d5e1bab93af5708159c9d9fe0b43ed75d6ac15b5f9c9/virtualenv-20.16.0.tar.gz
...
%prep
%setup -q -n virtualenv-20.16.0
cd %{_builddir}/virtualenv-20.16.0
pushd ..
cp -a virtualenv-20.16.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1658842258
