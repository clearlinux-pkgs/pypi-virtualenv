...
Source0  : https://files.pythonhosted.org/packages/22/a2/90da38a06254d3df8319c970586babc7cb8862787c9fa579b8c1eacfd5c7/virtualenv-20.18.0.tar.gz
...
%prep
%setup -q -n virtualenv-20.18.0
cd %{_builddir}/virtualenv-20.18.0
pushd ..
cp -a virtualenv-20.18.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1675734799
