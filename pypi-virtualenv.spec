...
Source0  : https://files.pythonhosted.org/packages/4a/c3/04f361a90ed4e6b3f3f696d61db5c786eaa741d2a6c125bc905b8a1c0200/virtualenv-20.14.0.tar.gz
...
%prep
%setup -q -n virtualenv-20.14.0
cd %{_builddir}/virtualenv-20.14.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1648354699
...
cp %{_builddir}/virtualenv-20.14.0/LICENSE %{buildroot}/usr/share/package-licenses/pypi-virtualenv/bcaf1877d014a17d06f0e23264c6429acf921d01
