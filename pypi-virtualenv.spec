...
Source0  : https://files.pythonhosted.org/packages/68/60/db9f95e6ad456f1872486769c55628c7901fb4de5a72c2f7bdd912abf0c1/virtualenv-20.26.3.tar.gz
...
%prep
%setup -q -n virtualenv-20.26.3
cd %{_builddir}/virtualenv-20.26.3
pushd ..
cp -a virtualenv-20.26.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1719250607
