...
Source0  : https://files.pythonhosted.org/packages/f1/6d/6c92388af71432c2261476f60c254c3982b6b02f66a33e88a14cc845a8b5/virtualenv-20.13.2.tar.gz
...
%prep
%setup -q -n virtualenv-20.13.2
cd %{_builddir}/virtualenv-20.13.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1645720237
...
cp %{_builddir}/virtualenv-20.13.2/LICENSE %{buildroot}/usr/share/package-licenses/pypi-virtualenv/bcaf1877d014a17d06f0e23264c6429acf921d01
