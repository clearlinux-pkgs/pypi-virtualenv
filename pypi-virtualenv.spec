...
Source0  : https://files.pythonhosted.org/packages/a4/2f/05b77cb73501c01963de2cef343839f0803b64aab4d5476771ae303b97a6/virtualenv-20.15.1.tar.gz
...
%prep
%setup -q -n virtualenv-20.15.1
cd %{_builddir}/virtualenv-20.15.1
pushd ..
cp -a virtualenv-20.15.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1656514104
...
cp %{_builddir}/virtualenv-20.15.1/LICENSE %{buildroot}/usr/share/package-licenses/pypi-virtualenv/bcaf1877d014a17d06f0e23264c6429acf921d01
